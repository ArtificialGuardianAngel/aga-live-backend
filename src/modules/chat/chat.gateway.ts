...
import { CustomSocket } from "src/core/adapters/redis.io.adapter";
import { RmqService } from "src/core/rmq/rmq.service";
import { ChatEventDto } from "./dto/chat.dto";
import * as crypto from "crypto";
import { ID } from "src/types";
import { ChatDocumnet } from "src/core/entities/prompt.entity";
      ...
      try {
        ...
        if (data.end) {
          ...
          if (this.chats[socketId].isConnected)
            socket.emit("prompt_reply_end", data);
